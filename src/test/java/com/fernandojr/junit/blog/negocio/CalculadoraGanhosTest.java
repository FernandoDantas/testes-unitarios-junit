...
import com.fernandojr.junit.blog.modelo.Editor;
import com.fernandojr.junit.blog.modelo.Ganhos;
import com.fernandojr.junit.blog.modelo.Post;
import com.fernandojr.junit.blog.utilidade.ProcessadorTextoSimples;
...
class CalculadoraGanhosTest {
    ...
    @BeforeEach
    void beforeEach(){
        autor = new Editor(1L, "Fernando", "fernando@email.com", new BigDecimal(5), true);

        post = new Post(1L, "Ecossistema Java", "O ecossistema do Java é muito moderno", autor,
