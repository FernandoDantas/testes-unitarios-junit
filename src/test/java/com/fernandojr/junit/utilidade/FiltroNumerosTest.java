...
class FiltroNumerosTest {
    ...
    //Dado, Quando, Então
    @Test
    public void Dado_uma_lista_de_numeros_Qaundo_filtrar_por_pares_Entao_deve_retornar_apenas_numeros_pares(){
    ...
    @Test
    public void Dado_uma_lista_de_numeros_Qaundo_filtrar_por_impares_Entao_deve_retornar_apenas_numeros_impares(){
        List<Integer> numeros = Arrays.asList(1, 2, 3, 4);
